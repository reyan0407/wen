...
function wendysmenu_scripts() {
    ...
    // Enqueue custom JavaScript with defer and version - FIXED PATH
    if (file_exists(get_template_directory() . '/script.js')) {
        wp_enqueue_script('wendysmenu-js', get_template_directory_uri() . '/script.js', array(), filemtime(get_template_directory() . '/script.js'), true);
